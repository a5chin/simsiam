...
def make_parser():
    ...
    parser.add_argument("-r", "--root", default="data", type=str, help="please set data root")
    ...
    parser.add_argument("--fix-pred-lr", default=True, type=bool, help="fix learning rate for the predictor")
